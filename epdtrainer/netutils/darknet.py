...
from epdtrainer.netutils.convbasics import BaseConv, DWConv, CSPLayer, Focus, ResLayer, SPPBottleneck
...
class CSPDarknet(nn.Module):
    def __init__(
        ...
        # self.stem = Focus(1, base_channels, ksize=3, act=act, qat=qat)
        ...
        self.dark5 = nn.Sequential(
            ...
            # SPPBottleneck(base_channels * 16, base_channels * 16, activation=act, qat=qat),
            CSPLayer(
                base_channels * 16,
                base_channels * 16,
                n=base_depth,
